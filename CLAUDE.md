...
- **Backlog:** i18n EN · mobile/WASM · barrel · grass verlet · sons (adiado pelo user) · multi-pair wang (6 pares painterly prontos, engine usa 2) · vsync toggle pra medir FPS real · validação user pendente: hanabi runtime, neve v2, balões, sombras TOD, radar-minimapa (ilha pede RECOMEÇAR)
