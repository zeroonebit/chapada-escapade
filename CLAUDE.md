...
- **Backlog:** crateras por deformação de heightfield (beam cava) · mobile/WASM · grass verlet · sons (adiado pelo user) · vsync toggle · publicar repo Bevy no GitHub (local-only hoje — decisão do user) · upgrade Bevy 0.15→0.19 (quando polish acalmar) · validação user pendente: de 2026-07-11 terraços de bioma + medo do vazio + radar sprites/névoa/dial final + queda centrada (o resto foi playtestado ao vivo) + i18n/tradução (2026-07-08) + itens de 07-07/07-06 ainda não vistos
