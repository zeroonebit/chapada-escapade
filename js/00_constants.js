...
// ── BEAM / ufo ───────────────────────────────────────────────────
const BEAM_RADIUS_BASE   = 40 * 5.55 / 2;   // radius cone do beam
...
const CURSOR_REACH       = 220;             // radius do cursor virtual (joystick/wasd)
...
// ── HELPER: testa se cow/ox can ser abduzida now ─────────────
...
// Helper de distance squared (avoids Math.sqrt em comparações)
